# HIMATEKIA - Election System for BPH Leadership & Senator

## Overview
This is a Next.js-based voting application for HIMATEKIA (Himpunan Mahasiswa Teknik Kimia) elections for BPH leadership and senators. The application provides a secure platform for students to register, receive QR codes for validation, and cast their votes.
...
- Clean, accessible design with HIMATEKIA branding (blue theme #2596be)
