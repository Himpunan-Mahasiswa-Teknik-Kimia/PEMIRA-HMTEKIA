...
export default function CandidateManagement() {
  ...
  const [formData, setFormData] = useState({
    ...
    nim: "",
    prodi: "",
    position: "KETUA_BPH" as 'KETUA_BPH' | 'SENATOR',
    visi: "",
    misi: "",
    photo: "",
  })
    ...
    if (!photoFile && formData.photo.trim()) {
      ...
      if (!photo.startsWith('/')) {
        try {
          ...
          errors.photo = 'Path foto harus dimulai dengan / atau berupa URL yang valid'
        }
      }
    }
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Kelola data kandidat Ketua BPH & Senator</CardDescription>
            </div>
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="KETUA_BPH">Ketua BPH</SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="/No.1 Ketua BPH.jpg atau /No.1 Senator.jpg"
                    ...
                    <TableRow key={candidate.id}>
                      ...
                      <TableCell>
                        <Badge variant="outline">
                          {candidate.position === 'KETUA_BPH' ? 'Ketua BPH' : 'Senator'}
                        </Badge>
                      </TableCell>
                      <TableCell>
